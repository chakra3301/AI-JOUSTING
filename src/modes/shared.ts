...
export function heraldInstructions(
  ...
  return [
    ...
    "",
    "Score the CURRENT pass only. Return ONLY valid JSON, no preamble, no markdown fences, matching exactly this shape:",
    "{",
    `  "pass": ${nextPass},`,
    '  "scores": {',
    '    "a": { "hit": "direct|glancing|miss|unseat", "reasoning": "..." },',
    '    "b": { "hit": "direct|glancing|miss|unseat", "reasoning": "..." }',
    "  },",
    '  "unseat": false,',
    '  "unseated_agent": null,',
